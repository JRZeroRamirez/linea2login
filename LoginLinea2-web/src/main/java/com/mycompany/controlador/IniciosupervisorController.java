...
@Named
@SessionScoped
public class IniciosupervisorController implements Serializable{

    private DTOUsuario user;
    /**
     * Creates a new instance of InicioDirectorController
     */
    public IniciosupervisorController() {
    }
        ...
        try {
            ...
            if (usuario == null) {
                FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error",
                        "Está tratando de ingresar de manera no autorizada al sitio.");
